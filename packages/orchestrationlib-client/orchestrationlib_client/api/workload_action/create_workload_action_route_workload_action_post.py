...
from ...models.workload_action_create import WorkloadActionCreate


def _get_kwargs(
    *,
    body: WorkloadActionCreate,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (WorkloadActionCreate): Schema for creating a workload action.
