...
T = TypeVar("T", bound="WorkloadRequestDecisionCreate")


@_attrs_define
class WorkloadRequestDecisionCreate:
    ...
    Attributes:
        ...
        created_at (Union[None, Unset, datetime.datetime]):  Default: isoparse('2025-10-21T10:16:51.412707Z').
    ...
    created_at: Union[None, Unset, datetime.datetime] = isoparse(
        "2025-10-21T10:16:51.412707Z"
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workload_request_decision_create = cls(
            pod_id=pod_id,
            pod_name=pod_name,
            namespace=namespace,
            node_id=node_id,
        ...
        workload_request_decision_create.additional_properties = d
        return workload_request_decision_create
