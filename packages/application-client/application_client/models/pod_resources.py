...
class PodResources:
    ...
    Attributes:
        id (ResourceId):
        replica (int):
        requests (PodResourcesRequests):
        limits (PodResourcesLimits):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        requests = PodResourcesRequests.from_dict(d.pop("requests"))

        limits = PodResourcesLimits.from_dict(d.pop("limits"))
        ...
        pod_resources.additional_properties = d
