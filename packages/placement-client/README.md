# placement_client
A client library for accessing Placement Controller

## Usage
First, create a client:

```python
from placement_client import Client
...
```python
from placement_client import AuthenticatedClient
...
```python
from placement_client.models import MyDataModel
from placement_client.api.my_tag import get_my_data_model
from placement_client.types import Response
...
1. Any endpoint which did not have a tag will be in `placement_client.api.default`
