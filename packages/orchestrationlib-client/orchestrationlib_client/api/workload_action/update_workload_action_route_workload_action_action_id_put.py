...
from ...models.workload_action_update import WorkloadActionUpdate
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        action_id (UUID):
        body (WorkloadActionUpdate): Schema for updating a workload action.
