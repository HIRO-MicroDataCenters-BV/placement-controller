...
T = TypeVar("T", bound="WorkloadTimingUpdate")


@_attrs_define
class WorkloadTimingUpdate:
    ...
    Attributes:
        ...
        recorded_at (Union[None, Unset, datetime.datetime]):  Default: isoparse('2025-10-21T10:16:51.445987Z').
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workload_timing_update.additional_properties = d
        return workload_timing_update
