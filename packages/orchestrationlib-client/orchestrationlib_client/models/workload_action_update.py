...
T = TypeVar("T", bound="WorkloadActionUpdate")


@_attrs_define
class WorkloadActionUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workload_action_update.additional_properties = d
        return workload_action_update
