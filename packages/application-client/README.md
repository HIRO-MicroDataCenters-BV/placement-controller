# application_client
A client library for accessing AnyApplication Controller

## Usage
First, create a client:

```python
from application_client import Client
...
```python
from application_client import AuthenticatedClient
...
```python
from application_client.models import MyDataModel
from application_client.api.my_tag import get_my_data_model
from application_client.types import Response
...
1. Any endpoint which did not have a tag will be in `application_client.api.default`
